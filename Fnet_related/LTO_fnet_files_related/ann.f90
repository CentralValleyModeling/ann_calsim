...
module ann
  ...
  real :: scalingLow=0.1, scalingHigh=0.9 !3/23/2006
    ...
    real ::     SJR_SCALE = 0.00001535,   SJR_OFFSET = 0.094190263
    real ::     SFtide_SCALE = 0.132677, SFtide_OFFSET = -0.314415311
    real ::     DICU_SCALE = 0.00009832, DICU_OFFSET = 0.58812599
    real ::     VernEC_SCALE = 0.80000000, VernEC_OFFSET = 0.10000000 
    

    !Output scaling factors
    real ::        jpt_scale = 0.00023080,      jpt_OFFSET = 0.066990152  ! 
    real ::      orrsl_scale = 0.00056882,    orrsl_OFFSET = 0.038498389 ! 
    real ::        emm_scale = 0.00014203,      emm_OFFSET = 0.075691272 ! 
    real ::    antioch_scale = 0.00008527, antioch_OFFSET = 0.087540561 ! 
    ...
    real :: middleriver_scale = 0.00084822, middleriver_OFFSET = 0.005942131 ! 
    ...
    real :: beldan_scale = 0.00004443, beldan_offset = 0.092111152
    real :: MTZ_scale = 0.00002901, MTZ_offset = 0.086500372
    !end of add         
