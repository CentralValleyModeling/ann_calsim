...
def collate_calsim_inputs_for_ann(dssfile):
    ...
    '''
    sac = add_pathnames(dssfile, ['/CALSIM-SMOOTH/C_SAC041/FLOW//1DAY/L2020A_CS3V27_BASE/',
                                  '/CALSIM/C_CSL004A/CHANNEL//1MON/L2020A/',
                                  '/CALSIM/C_CLV004/FLOW//1MON/L2020A_CS3V27_BASE/',
                                  '/CALSIM/C_MOK019/CHANNEL//1MON/L2020A/'])
    exports = add_pathnames(dssfile, ['/CALSIM/C_CAA003_TD/FLOW//1MON/L2020A_CS3V27_BASE/',
                                      '/CALSIM/C_DMC000_TD/FLOW//1MON/L2020A_CS3V27_BASE/',
                                      '/CALSIM/D408/FLOW//1MON/L2020A_CS3V27_BASE/',
                                      '/CALSIM/D_SJR028_WTPDWS/FLOW//1MON/L2020A_CS3V27_BASE/'])
    dcc=add_pathnames(dssfile, ['/CALSIM-PROCESSED/DCC/OP//IR-YEAR/L2020A_CS3V27_BASE/'])
    net_dcd=add_pathnames(dssfile, ['/CALSIM/NET_DICU/DICU_FLOW//1MON/L2020A/'])
    sjr = add_pathnames(dssfile, ['/CALSIM-SMOOTH/C_SJR070/FLOW//1DAY/L2020A_CS3V27_BASE/'])
