...
def collate_calsim_inputs_for_ann(dssfile):
    ...
    '''
    sac = add_pathnames(dssfile, ['/CALSIM-SMOOTH/C_SAC048/FLOW//1DAY/L2020A_1EX_DEC_NOSMSCG/',
                                  '/CALSIM/C_CSL004A/CHANNEL//1MON/L2020A/',
                                  '/CALSIM/C_CLV004/FLOW//1MON/L2020A_1EX_DEC_NOSMSCG/',
                                  '/CALSIM/C_MOK019/CHANNEL//1MON/L2020A/'])
    exports = add_pathnames(dssfile, ['/CALSIM/C_CAA003_TD/FLOW//1MON/L2020A_1EX_DEC_NOSMSCG/',
                                      '/CALSIM/C_DMC000_TD/FLOW//1MON/L2020A_1EX_DEC_NOSMSCG/',
                                      '/CALSIM/D408/FLOW//1MON/L2020A_1EX_DEC_NOSMSCG/',
                                      '/CALSIM/D_SJR028_WTPDWS/FLOW//1MON/L2020A_1EX_DEC_NOSMSCG/'])
    ...
    sjr = add_pathnames(dssfile, ['/CALSIM-SMOOTH/C_SJR070/FLOW//1DAY/L2020A_1EX_DEC_NOSMSCG/'])
    tide = add_pathnames(dssfile, ['/DWR/SAN_FRANCISCO/STAGE-MAX-MIN//1DAY/ASTRO_NAVD_20170607/'])
    smscg = add_pathnames(dssfile, ['/CALSIM/SMSCG_OP/GATE-OP-RATIO//1DAY/L2020A_1EX_DEC_NOSMSCG/'])
