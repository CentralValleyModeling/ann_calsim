...
def collate_calsim_inputs_for_ann(dssfile):
    ...
    '''
    sac = add_pathnames(dssfile, ['/CALSIM-SMOOTH/C_SAC041/FLOW//1DAY/L2020A_SMSCG_NAA_2040M_SLR15CM/',
    ...
    exports = add_pathnames(dssfile, ['/CALSIM/C_CAA003_TD/FLOW//1MON/L2020A_SMSCG_NAA_2040M_SLR15CM/',
    ...
    sjr = add_pathnames(dssfile, ['/CALSIM-SMOOTH/C_SJR070/FLOW//1DAY/L2020A_SMSCG_NAA_2040M_SLR15CM/'])
    tide = add_pathnames(dssfile, ['/DWR/SAN_FRANCISCO/STAGE-MAX-MIN//1DAY/ASTRO_NAVD_20170607/'])
    smscg = add_pathnames(dssfile, ['/CALSIM/SMSCG_OP/GATE-OP-RATIO//1MON/L2020A_SMSCG_NAA_2040M_SLR15CM/'])
