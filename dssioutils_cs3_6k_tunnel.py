...
def collate_calsim_inputs_for_ann(dssfile):
    ...
    '''
    sac = add_pathnames(dssfile, ['/CALSIM-SMOOTH/C_SAC041/FLOW//1DAY/L2020A_CS3V27_6K/',
                                  '/CALSIM/C_CSL004A/CHANNEL//1MON/L2020A/',
                                  '/CALSIM/C_CLV004/FLOW//1MON/L2020A_CS3V27_6K/',
                                  '/CALSIM/C_MOK019/CHANNEL//1MON/L2020A/'])
    exports = add_pathnames(dssfile, ['/CALSIM/C_CAA003_TD/FLOW//1MON/L2020A_CS3V27_6K/',
                                      '/CALSIM/C_DMC000_TD/FLOW//1MON/L2020A_CS3V27_6K/',
                                      '/CALSIM/D408/FLOW//1MON/L2020A_CS3V27_6K/',
                                      '/CALSIM/D_SJR028_WTPDWS/FLOW//1MON/L2020A_CS3V27_6K/'])
    dcc=add_pathnames(dssfile, ['/CALSIM-PROCESSED/DCC/OP//IR-YEAR/L2020A_CS3V27_6K/'])
    net_dcd=add_pathnames(dssfile, ['/CALSIM/NET_DICU/DICU_FLOW//1MON/L2020A/'])
    sjr = add_pathnames(dssfile, ['/CALSIM-SMOOTH/C_SJR070/FLOW//1DAY/L2020A_CS3V27_6K/'])
    tide = add_pathnames(dssfile, ['/DWR/SAN_FRANCISCO/STAGE-MAX-MIN//1DAY/ASTRO_NAVD_20170607/'])
    smscg = add_pathnames(dssfile, ['/CALSIM/SMSCG_OP/GATE-OP-RATIO//1MON/L2020A_CS3V27_6K/'])
