...
module ann
  ...
  real :: scalingLow=0.1, scalingHigh=0.9 !3/23/2006
    ...
    real ::     DXC_SCALE = 0.8,   DXC_OFFSET = 0.10000000
    real ::     EXP_SCALE = 0.000059,   EXP_OFFSET = 0.03207506
    real ::     SAC_SCALE = 0.000003,   SAC_OFFSET = 0.082276484
    real ::     SJR_SCALE = 0.000015,   SJR_OFFSET = 0.094190263
    real ::     SFtide_SCALE = 0.132677, SFtide_OFFSET = -0.314415311
    real ::     DICU_SCALE = 0.000098, DICU_OFFSET = 0.588125985
    real ::     VernEC_SCALE = 0.80000000, VernEC_OFFSET = 0.10000000 
    

    !Output scaling factors
    real ::        jpt_scale = 0.000231,      jpt_OFFSET = 0.066990152  ! 
    real ::      orrsl_scale = 0.000569,    orrsl_OFFSET = 0.038498389 ! 
    real ::        emm_scale = 0.000142,      emm_OFFSET = 0.075691272 ! 
    real ::    antioch_scale = 0.000085, antioch_OFFSET = 0.087540561 ! 
    real ::    collins_scale = 0.000056, collins_OFFSET = 0.09070051 ! 
    ...
    real :: CCFBintake_scale = 0.000761, CCFBintake_OFFSET = 0.02600466 
    real :: middleriver_scale = 0.000848, middleriver_OFFSET = 0.005942131 ! 
    real :: VICTintake_scale  = 0.000831, VICTintake_OFFSET = 0.01786704 ! 
    real :: CVPintake_scale  = 0.000801, CVPintake_OFFSET =0.020521201 ! 
    real :: x2_scale = 0.016438, X2_OFFSET = -0.686784195 
    real :: beldan_scale = 0.000044, beldan_offset = 0.092111152
    real :: MTZ_scale = 0.000029, MTZ_offset = 0.086500372
    !end of add         
...
!       if(inarray(i+inarray_offset+ndays)< (scalingLow-0.01) .or. inarray(i+inarray_offset+ndays) > (scalingHigh+0.01)) then !3/23/2006
 !        scaleAndCopyDaily = .TRUE.
  ...
  function calcdaily(sac,sjr,export,currSFtide,DICU,dxc,VernEC,location)!shengjun 12/16/2004 and 2/25/2005
    ...
    !else        
        EXP_SCALE = 0.000061;   EXP_OFFSET = 0.03207506;
        SAC_SCALE = 0.000003;   SAC_OFFSET = 0.082276484;
  ...
  function calcX2daily(sac,export,currSFtide,location)!Hao Mar 2009
    ...
    if (location == 13) then !use the same 6 input names but different meaning, make sure the order is the same of ANN input
       ...
       ! SF tide a: 0.13652
        ...
        EXP_SCALE = 0.00000284; EXP_OFFSET = 0.093534394;     ! Delta_outflow
